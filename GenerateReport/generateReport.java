...
public class generateReport {
    ...
    public static void individualPerformanceReport() {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("SELECT Staff.Name as Staff_Name, Task.Task_ID as Task_ID, Task.Location as Location, Task.Duration as Duration,\n" +
    ...
    public static void individualReport() {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("SELECT Date, Job_No AS Job_Number, Customer.Customer_Name AS Customer_Name FROM Job \n" +
